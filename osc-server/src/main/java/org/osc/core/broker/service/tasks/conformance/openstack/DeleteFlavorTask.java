...
public class DeleteFlavorTask extends TransactionalTask {
    ...
    public void executeTransaction(EntityManager em) throws Exception {
        ...
        // We have to find the entity again as the one reference by this.flavorReference is detached.
        OSCEntityManager.delete(em, em.find(OsFlavorReference.class, this.flavorReference.getId()), this.txBroadcastUtil);
    }
